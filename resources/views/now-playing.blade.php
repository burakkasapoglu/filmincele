@extends('layouts.app')
@section('title', 'Vizyonda — Filmincele')

@section('content')
<div class="max-w-7xl mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold text-white mb-2">🍿 Vizyondaki Filmler</h1>
    <p class="text-gray-400 mb-8">Şu anda sinemalarda oynayan filmler</p>

    @php
        $tmdb = app(\App\Services\TmdbService::class);
        $movies = $tmdb->getNowPlaying();
    @endphp
    ...
    @if(empty($movies))
        <div class="text-center py-20 text-gray-500">
            ...
            <p>Şu anda vizyonda içerik bulunamadı.</p>
        </div>
    @endif
</div>
@endsection
