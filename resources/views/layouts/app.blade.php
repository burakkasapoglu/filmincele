...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('favicon-48.png') }}">
    ...
    <link href="https://fonts.bunny.net/css?family=inter:400,500,600,700,800&display=swap" rel="stylesheet" media="print" onload="this.media='all'">
